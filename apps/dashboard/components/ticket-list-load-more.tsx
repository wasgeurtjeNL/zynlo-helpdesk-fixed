    ...
    <div className={cn('h-full flex flex-col', className)}>
      ...
      <div className="px-4 py-3 border-b border-gray-100 bg-gray-50">
        ...
        {debouncedSearchQuery && (
          <p className="text-xs text-gray-500 mt-2">{filteredTickets.length} tickets gevonden</p>
        )}
        {!debouncedSearchQuery && (
          <p className="text-xs text-gray-500 mt-2">{allTickets.length} tickets geladen</p>
        )}
      </div>
